...
print(class(num_list["two"])) #one bracket = list
print(class(num_list[["two"]])) #double brackets = character
```
...
math_scores[1:3]
# Remove by index
math_scores[-(4:5)] #except fourth and fifth 
# Filter by a condition
math_scores[which(verbal_scores >= 90)] #2nd and 3rd indexes 
# Set a value
math_scores[3] <- 92
...
# To read more about function documentation in R, see:
